...
show_usage_instructions() {
    ...
    case "$os_type" in
        ...
        *)
            ...
            log_info "  NIX_DOTFILES_PATH=/path/to/dotfiles home-manager switch --impure --flake .#$hostname"
            log_info ""
            log_info "  # Both custom username and path:"
            log_info "  NIX_USERNAME=kata NIX_DOTFILES_PATH=/custom/path home-manager switch --impure --flake .#$hostname"
            log_info ""
            log_info "To see available configurations:"
            log_info "  nix flake show"
            log_info ""
