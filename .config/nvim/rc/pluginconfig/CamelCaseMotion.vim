nnoremap <silent> [_SubLeader]w :<C-U>call camelcasemotion#Motion('w', v:count1, 'n')<CR>
nnoremap <silent> [_SubLeader]b :<C-U>call camelcasemotion#Motion('b', v:count1, 'n')<CR>
nnoremap <silent> [_SubLeader]e :<C-U>call camelcasemotion#Motion('e', v:count1, 'n')<CR>
nnoremap <silent> [_SubLeader]ge :<C-U>call camelcasemotion#Motion('ge', v:count1, 'n')<CR>
