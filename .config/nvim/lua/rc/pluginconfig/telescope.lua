...
vim.api.nvim_set_keymap('n', '<Leader>p', '<Cmd>Telescope my_mru<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<fuzzy-finder>p', '<Cmd>Telescope find_files<CR>', { noremap = true, silent = true })
