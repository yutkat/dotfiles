...
vim.keymap.set("n", "gr", "<cmd>Lspsaga rename<cr>", {silent = true, noremap = true, buffer = 0})
vim.keymap.set("n", "gx", "<cmd>Lspsaga code_action<cr>",
               {silent = true, noremap = true, buffer = 0})
vim.keymap.set("x", "gx", ":<c-u>Lspsaga range_code_action<cr>",
               {silent = true, noremap = true, buffer = 0})
vim.keymap.set("n", "K", "<cmd>Lspsaga hover_doc<cr>", {silent = true, noremap = true, buffer = 0})
