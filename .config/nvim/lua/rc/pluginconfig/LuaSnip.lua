...
ls.snippets = {
  ...
  all = {
    ...
    s("fn", {
      ...
      c(1, {t("public "), t("private ")}), t("class "), i(2), t(" "), c(3, {
        t("{"),
    ...
    s("fmt1",
      fmt("To {title} {} {}.", {i(2, "Name"), i(3, "Surname"), title = c(1, {t("Mr."), t("Ms.")})})),
    ...
    s("novel", {
      t("It was a dark and stormy night on "), d(1, date_input, {}, "%A, %B %d of %Y"),
    ...
    s("transform", {
      ...
      i(1, "initial text"), t("::"), i(2, "replacement for e"), t({"", ""}),
    ...
    s("link_url", {
      t('<a href="'), f(function(_, snip) return snip.env.TM_SELECTED_TEXT[1] or {} end, {}),
      t('">'), i(1), t("</a>"), i(0)
    ...
    s("mat4", {
      i(1, {"sample_text"}), t(": "),
      m(1, function(text) return (#text % 2 == 0 and text) or nil end)
  ...
  java = {
    ...
    s("fn", {
      ...
      c(5, {t(""), sn(nil, {t({"", " throws "}), i(1)})}), t({" {", "\t"}), i(0), t({"", "}"})
    })
  },
  tex = {
