...
vim.api.nvim_set_keymap("i", "<C-Down>", "luasnip#choice_active() ? '<Plug>luasnip-next-choice' : '<C-E>'", {})
vim.api.nvim_set_keymap("s", "<C-Down>", "luasnip#choice_active() ? '<Plug>luasnip-next-choice' : '<C-E>'", {})
