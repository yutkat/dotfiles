...
vim.api.nvim_set_keymap("n", "<make>m", "<Cmd>TaskRunnerTerminalToggle<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<make>q", "<Cmd>TaskRunnerTerminalToggle<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<make>r", "<Cmd>lua TaskRunnerTerminalLast()<CR>", { noremap = true, silent = true })
